...
class InstallerFunctions {
    ...
    public static function writeDBConnectionFile($h, $u, $pa, $d, $pr) {
        ...
        $file = file($file_path);
        $file[4] = '$dbc[\'host\'] = \''.addcslashes($h, "\'").'\';';
        $file[6] = '$dbc[\'user\'] = \''.addcslashes($u, "\'").'\';';
        $file[8] = '$dbc[\'pass\'] = \''.addcslashes($pa, "\'").'\';';
        $file[10] = '$dbc[\'data\'] = \''.addcslashes($d, "\'").'\';';
        $file[12] = '$dbc[\'pref\'] = \''.addcslashes($pr, "\'").'\';';
        
        return file_write_contents($file_path, $file);
    }
