...
$steps['ftp']['step'][1]['info_text']    = 'Die <b>Berechtigungen</b> f&uuml;r den Zugriff auf die zur Installation erforderlichen Dateien m&uuml;ssen <b>gepr&uuml;ft</b> werden.';
...
$steps['settings']['step'][2]['error1']         = 'Bitte f&uuml;llen Sie alle <b>Pflichtfelder</b> aus.';
...
$steps['files']['step'][1]['info_text']    = 'Es werden nun einige <b>ver&auml;nderte Dateien</b> aus dem Installations- in das Hauptverzeichnis Ihrer Webseite <b>kopiert</b>.';
$steps['files']['step'][1]['error1']       = 'Beim Kopieren der ver&auml;nderten Dateien trat ein Fehler auf. Bitte <b>versuchen</b> Sie es <b>erneut</b>.';
...
$steps['files']['step'][2]['end_info']     = 'Die <b>&Uuml;berpr&uuml;fung</b> der Zugriffsrechte war <b>erfolgreich</b>. Sie k&ouml;nnen nun mit der Installation fortfahren.';
...
$steps['files']['end_info']                = 'Die &Auml;nderungen am Dateisystem wurden <b>erfolgreich</b> abgeschlossen.';
...
$steps['end']['link_admin']            = 'Das <b>Administrator-Control-Panel</b> (kurz: Admin-CP) erreichen Sie &uuml;ber folgenden Link:';
...
$help['lang']['text']                   = 'Please select your language.<br>Bitte w&auml;hlen Sie Ihre Sprache.';
