...
<!--IF::sql_error--><p class="error"><!--TEXT::sql_connection_error--></p><!--ENDIF::sql_error-->
...
<p><label for="db_user"><!--LANG::sql_user_label--></label><input type="text" name="db_user" id="db_user" value="frogsyste"></p>
